...
import { loadModels, createMatcher,  getFaceDescriptionMtcnn} from '../api/face';
import '../App.css';
...
const CameraFaceDetectSingleMtcnn = (props) => {
...
export default withRouter(CameraFaceDetectSingleMtcnn);
